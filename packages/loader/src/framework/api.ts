...
const protos = {
  ...
  MaaResourcePostResource: 'MaaResId MaaResourcePostResource(MaaResourceHandle res, MaaString path)',
  ...
  MaaResourceGetHash: 'MaaSize MaaResourceGetHash(MaaResourceHandle res, char* buff, MaaSize buff_size)',
  ...
  MaaControllerPostClick: 'MaaCtrlId MaaControllerPostClick(MaaControllerHandle ctrl, int32_t x, int32_t y)',
  ...
  MaaControllerGetImage: 'MaaSize MaaControllerGetImage(MaaControllerHandle ctrl, void* buff, MaaSize buff_size)',
  MaaControllerGetUUID: 'MaaSize MaaControllerGetUUID(MaaControllerHandle ctrl, char* buff, MaaSize buff_size)',
  MaaCreate: 'MaaInstanceHandle MaaCreate(MaaInstanceCallback callback, MaaCallbackTransparentArg callback_arg)',
  ...
  MaaUnregisterCustomRecognizer: 'MaaBool MaaUnregisterCustomRecognizer(MaaInstanceHandle inst, MaaString name)',
  ...
  MaaUnregisterCustomAction: 'MaaBool MaaUnregisterCustomAction(MaaInstanceHandle inst, MaaString name)',
  ...
  MaaSetTaskParam: 'MaaBool MaaSetTaskParam(MaaInstanceHandle inst, MaaTaskId id, MaaJsonString param)',
  MaaTaskStatus: 'MaaStatus MaaTaskStatus(MaaInstanceHandle inst, MaaTaskId id)',
  MaaTaskWait: 'MaaStatus MaaTaskWait(MaaInstanceHandle inst, MaaTaskId id)',
