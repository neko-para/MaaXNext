...
export const MaaCustomControllerAPI = koffi.struct('MaaCustomControllerAPI', {
  ...
  start_app: koffi.pointer(koffi.proto('MaaBool MaaCustomControllerAPI_StartApp(MaaString package_name)')),
  stop_app: koffi.pointer(koffi.proto('MaaBool MaaCustomControllerAPI_StopApp(MaaString package_name)')),

  get_resolution: koffi.pointer(
    koffi.proto('MaaBool MaaCustomControllerAPI_GetResolution(int32_t* width, int32_t* height)')
  ),
  get_image: koffi.pointer(koffi.proto('MaaSize MaaCustomControllerAPI_GetImage(uint8_t* buff, MaaSize buff_size)')),
  get_uuid: koffi.pointer(koffi.proto('MaaSize MaaCustomControllerAPI_GetUUID(char* buff, MaaSize buff_size)'))
})
export const MaaCustomControllerHandle = koffi.alias('MaaCustomControllerHandle', 'MaaCustomControllerAPI*')
...
export const MaaCustomRecognizerAPI = koffi.struct('MaaCustomRecognizerAPI', {
  analyze: koffi.pointer(
    koffi.proto(
      'MaaBool MaaCustomRecognizerAPI_Analyze(const MaaImage* image, MaaJsonString custom_recognition_param, MaaRecognitionResult* result)'
    )
  )
})
export const MaaCustomRecognizerHandle = koffi.alias('MaaCustomRecognizerHandle', 'MaaCustomRecognizerAPI*')
